...
- **Escaping.** A `--config` path that holds U+001B prints it as `\u001b` in its failure, and a project file path that holds it prints it as `\u001b` in its warning.
