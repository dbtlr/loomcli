...
- 2026-09-13: Superseded by [ADR-0024](0024-application-registration-provides-globals-to-standalone-commands.md). That record replaces the affected rules and incorporates the remaining provisions and addenda by reference.
