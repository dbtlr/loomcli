...
ADR-0007, ADR-0008, and ADR-0020 remain accepted except for the specific clauses superseded by [ADR-0027](0027-core-resolves-marked-output-and-one-theme-contribution.md). When proposed [ADR-0031](0031-a-plugin-supplies-facts-to-another-plugins-projection-through-a-collecting-extension.md) is accepted, ADR-0020 and ADR-0025 also remain accepted except for the one clause of each it supersedes: the sibling-import sentence of ADR-0020 and, for a collecting extension alone, the replacement clause of ADR-0025.
