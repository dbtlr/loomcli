...
| [ADR-0033](0033-a-plugin-attaches-ordinary-commands-to-the-root.md) | A plugin definition may list ordinary Commands, which attach to the root in installation order before the application's own; every Command rule applies unchanged, the application cannot rename or remove them, and a collision is a build error. | proposed |

## Adding a record

ADR-0007, ADR-0008, and ADR-0020 remain accepted except for the specific clauses superseded by [ADR-0027](0027-core-resolves-marked-output-and-one-theme-contribution.md). ADR-0020 and ADR-0025 also remain accepted except for the clauses [ADR-0031](0031-a-plugin-supplies-facts-to-another-plugins-projection-through-a-collecting-extension.md) supersedes: ADR-0020's clause that a subpath imports nothing from a sibling, and, for a collecting extension alone, ADR-0025's replacement clause.
