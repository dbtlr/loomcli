...
**Validation.** Run the application's TypeScript check to find every retired name, then run its output and failure tests under Node and Bun. Compare the bytes of each branded diagnostic, help page, and version line before and after the change.
