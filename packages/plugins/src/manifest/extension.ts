 ...
 * supplies its values here whether or not the manifest is installed. It applies the pack's shared
 * line and prose rules, which help's schema also uses, so every value help supplies validates.
 */
